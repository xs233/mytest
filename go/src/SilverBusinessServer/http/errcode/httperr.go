...
//ErrRegisterDevice 注册设备失败
var ErrRegisterDevice = Err{10123, "Register device error"}

//ErrRegisterDeviceMult 重复注册
var ErrRegisterDeviceMult = Err{10124, "Multiple registration"}

//ErrPushAlarm 推送报警失败
var ErrPushAlarm = Err{10125, "Push Alarm error"}

//ErrSaveAlarm 保存报警失败
var ErrSaveAlarm = Err{10126, "Save Alarm error"}

//ErrQueryUnmonitorDevice 查询未进行算法分析的设备失败
var ErrQueryUnmonitorDevice = Err{10127, "Query Unmonitor Device error"}

//ErrQueryAlgConfig 查询指定设备的算法配置失败
var ErrQueryAlgConfig = Err{10128, "Query Alg Config error"}

//ErrGetDeviceType 获取指定设备的类型失败
var ErrGetDeviceType = Err{10129, "Get Device Type error"}

//ErrDeviceType 错误的设备类型
var ErrDeviceType = Err{10130, "Smart device must not be deleted"}

//ErrResetRight 重置用户权限出错
var ErrResetRight = Err{10131, "Reset right error"}