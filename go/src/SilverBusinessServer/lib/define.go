...
type Device struct {
	...
	P2PKey		  string `form:"p2pKey" json:"p2pKey"`
}
...
//Register live devices info
type RegisterLiveDevices struct {
	DeviceUUID  string `form:"deviceUUID" json:"deviceUUID"`
	DeviceIP    string `form:"deviceIP" json:"deviceIP"`
	RtspURL     string `form:"rtspURL" json:"rtspURL"`
	AlgID       string `form:"algID" json:"algID"`
...
//RegisterDeviceToDB fucntion return
const (
	RegisterSuccess int = iota
	RegisterFailed
	RegisterMultiple
)
...
//LiveKeeper return
type DeviceAlgStatus struct {
	Err    int              `form:"err" json:"err"`
	ErrMsg string           `form:"errMsg" json:"errMsg"`
	Data   DevAlgStatusList `form:"data" json:"data"`
}

type DevAlgStatusList struct {
	DevAlgStatusList []DeviceStatus `form:"devAlgStatusList" json:"devAlgStatusList"`
}

type DeviceStatus struct {
	DevID     string `form:"devID" json:"devID"`
	AlgID     string `form:"algID" json:"algID"`
	AlgStatus int    `form:"algStatus" json:"algStatus"`
}
